...
export enum ExternalLinks {
  ...
  SendCoinGuide = 'https://docs.spacemesh.io/docs/start/smeshing/smeshing_basic/wallet#sending-smidge',
  GetCoinGuide = 'https://testnet.spacemesh.io/#/get_coin', // TODO: update link, once we will have a public testnet with faucet
  WalletGuide = 'https://docs.spacemesh.io/docs/start/smeshing/smeshing_basic/wallet',
  BackupGuide = 'https://docs.spacemesh.io/docs/start/smeshing/smeshing_basic/advanced-wallet#backing-up',
  RestoreGuide = 'https://docs.spacemesh.io/docs/start/smeshing/smeshing_basic/advanced-wallet#restoring-a-wallet',
  RestoreFileGuide = 'https://docs.spacemesh.io/docs/start/smeshing/smeshing_basic/advanced-wallet#restoring-a-wallet',
  RestoreMnemoGuide = 'https://docs.spacemesh.io/docs/start/smeshing/smeshing_basic/advanced-wallet#restoring-a-wallet',
