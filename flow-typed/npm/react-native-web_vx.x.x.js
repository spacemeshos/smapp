...
type RNW$MeasureInWindowCallback = (left: number, top: number, width: number, height: number) => void;
...
declare class RNW$NativeMethodsMixin {
  ...
  measureLayout: (relativeToNativeNode: {}, onSuccess: RNW$MeasureLayoutCallback, onFail: () => void) => void;
...
type RNW$View$Props = {
  ...
  accessible?: boolean,
  children?: any,
  hitSlop?: $PropertyType<$Exports<'react-native-web/dist/exports/EdgeInsetsPropType/index'>, 'EdgeInsetsProp'>,
...
declare module 'react-native-web' {
  declare module.exports: {
    ...
    EdgeInsetsPropType: $Exports<'react-native-web/dist/exports/EdgeInsetsPropType/index'>,
    ...
    ImageBackground: $Exports<'react-native-web/dist/exports/ImageBackground/index'>,
    InteractionManager: $Exports<'react-native-web/dist/exports/InteractionManager/index'>,
    Keyboard: $Exports<'react-native-web/dist/exports/Keyboard/index'>,
    KeyboardAvoidingView: $Exports<'react-native-web/dist/exports/KeyboardAvoidingView/index'>,
    ...
    NativeModules: $Exports<'react-native-web/dist/exports/NativeModules/index'>,
    ...
    PointPropType: $Exports<'react-native-web/dist/exports/PointPropType/index'>,
    ProgressBar: $Exports<'react-native-web/dist/exports/ProgressBar/index'>,
    RefreshControl: $Exports<'react-native-web/dist/exports/RefreshControl/index'>,
    ...
    TextPropTypes: $Exports<'react-native-web/dist/exports/TextPropTypes/index'>,
    ...
    TouchableNativeFeedback: $Exports<'react-native-web/dist/exports/TouchableNativeFeedback/index'>,
    ...
    VirtualizedList: $Exports<'react-native-web/dist/exports/VirtualizedList/index'>,
    createElement: $Exports<'react-native-web/dist/exports/createElement/index'>,
    findNodeHandle: $Exports<'react-native-web/dist/exports/findNodeHandle/index'>,
    ...
    unmountComponentAtNode: $Exports<'react-native-web/dist/exports/unmountComponentAtNode/index'>
  };
...
declare module 'react-native-web/dist/exports/AppRegistry/index' {
  ...
  declare class RNW$AppRegistry {
    ...
    static registerComponent(appKey: string, getComponentFunc: RNW$AppRegistry$ComponentProvider): string;
...
declare module 'react-native-web/dist/exports/AppState/index' {
  ...
  declare class RNW$AppState {
    ...
    static addEventListener(type: RNW$AppState$State, handler: RNW$AppState$Listener): void;
    static removeEventListener(type: RNW$AppState$State, handler: RNW$AppState$Listener): void;
  }
...
declare module 'react-native-web/dist/exports/Dimensions/index' {
  declare class RNW$Dimensions {
    ...
    static addEventListener(type: 'change', callback: (dimensions: RNW$DimensionsObject) => void): void;
    static removeEventListener(type: 'change', callback: (dimensions: RNW$DimensionsObject) => void): void;
  }
...
declare module 'react-native-web/dist/exports/EdgeInsetsPropType/index' {
  declare module.exports: { EdgeInsetsProp: { top: number, bottom: number, left: number, right: number } };
}
...
declare module 'react-native-web/dist/exports/ImageBackground/index' {
  declare type RNW$Image = $Exports<'react-native-web/dist/exports/Image/index'>;
...
declare module 'react-native-web/dist/exports/NetInfo/index' {
  ...
  declare type RNW$NetInfo$ConnectionInfo = { effectiveType: string, type: string };
  declare type RNW$NetInfo$EventHandler = (info: RNW$NetInfo$ConnectionInfo) => void;
  declare type RNW$NetInfo$ConnectedHandler = (isConnected: boolean) => void;
  declare module.exports: {
    addEventListener(type: RNW$NetInfo$EventType, handler: RNW$NetInfo$EventHandler): { remove: () => void },
    removeEventListener(type: RNW$NetInfo$EventType, handler: RNW$NetInfo$EventHandler): void,
    fetch(): Promise<any>,
    getConnectionInfo(): Promise<RNW$NetInfo$ConnectionInfo>,
    isConnected: {
      addEventListener(type: RNW$NetInfo$EventType, handler: RNW$NetInfo$ConnectedHandler): { remove: () => void },
      removeEventListener(type: RNW$NetInfo$EventType, handler: RNW$NetInfo$ConnectedHandler): void,
...
declare module 'react-native-web/dist/exports/Picker/index' {
  ...
  declare type RNW$Picker$Children = React$Element<RNW$PickerItem> | Iterable<RNW$Picker$Children>;
...
declare module 'react-native-web/dist/exports/processColor/index' {
  declare module.exports: (color: ?(string | number), opacity?: number) => string;
}
...
declare module 'react-native-web/dist/exports/StyleSheet/index' {
  declare interface RNW$StyleSheet {
    ...
    create(styles: { [key: string]: RNW$StyleObject }): { [key: string]: RNW$Style };
    flatten(style: { [key: string]: RNW$Style }): ?{ [key: string]: RNW$StyleObject };
...
declare module 'react-native-web/dist/exports/UIManager/index' {
  declare interface RNW$UIManager {
    ...
    measureLayout(node: mixed, relativeToNativeNode: mixed, onFail: any, onSuccess: RNW$MeasureLayoutCallback): void;
...
declare module 'react-native-web/dist/exports/View/index' {
  declare class RNW$View extends React$Component<RNW$View$Props> mixins RNW$NativeMethodsMixin {}
