...
export interface MalfeasanceStreamResponse {
  'proof'?: (_spacemesh_v1_MalfeasanceProof | null);
}

export interface MalfeasanceStreamResponse__Output {
  'proof': (_spacemesh_v1_MalfeasanceProof__Output | null);
}
